...
if __name__ == "__main__":
    ...
    main_finetuen_dtu_branch_partial = functools.partial(
        main_finetuen_dtu_branch,
    ...
    main_finetuen_dtu_branch_partial(ex_num_samples=20, ex_num_users=5)
    main_finetuen_dtu_branch_partial(ex_num_samples=20, ex_num_users=10)
    main_finetuen_dtu_branch_partial(ex_num_samples=20, ex_num_users=20)
